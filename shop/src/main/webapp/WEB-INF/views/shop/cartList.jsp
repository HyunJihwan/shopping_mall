			...
			<section id="content">
				   <ul>
				    ...
				    <li>
				     ...
				     <div class="gdsInfo">
				      <p>
					       <span>상품명 :  ${cartList.gdsName}<br />
					       <span>개당 가격 :  <fmt:formatNumber pattern="###,###,###" value="${cartList.gdsPrice}" /> 원<br />
					       <span>구입 수량 :  ${cartList.cartStock} 개 <br />
					       <span>최종 가격 :  <fmt:formatNumber pattern="###,###,###" value="${cartList.gdsPrice * cartList.cartStock}" /> 원
				      </p>
